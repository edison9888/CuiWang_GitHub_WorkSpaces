...
@protocol GKSlideSwitchViewDelegate;

@interface GKSlideSwitchView : UIView<UIScrollViewDelegate>
{
    ...
    __weak id<GKSlideSwitchViewDelegate> _slideSwitchViewDelegate;
}
...
@property (nonatomic, weak)  id<GKSlideSwitchViewDelegate> slideSwitchViewDelegate;
...
@protocol GKSlideSwitchViewDelegate <NSObject>
 ...
 * @result
 */
- (void)slideSwitchView:(GKSlideSwitchView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
