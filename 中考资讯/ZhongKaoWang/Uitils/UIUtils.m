...
+(float)fileSizeForDir:(NSString*)filename//计算文件夹下文件的总大小

{
    ...
    while (fileName = [filesEnumerator nextObject]) {
        NSDictionary *fileAttributeDic=[fileManager attributesOfItemAtPath:[path stringByAppendingPathComponent:fileName] error:nil];
